...
def build_task_template(
    ...
    return f"""
        ...
        4. ABSOLUTELY DO NOT extract tables, statements, lists of financial accounts, charts, or infographics. This includes markdown tables (using pipes '|' or hyphens '-'), raw plaintext tabular/schedule dumps (such as balance sheet lines or rows/columns of numbers), standalone chart titles/labels (such as "YTD Performance Chart" or "Valuation Chart"), price-consensus labels, quote buttons, and links leading directly to charts or visual graphics. If important data is presented in a table, list, chart, or infographic, you MUST ignore the visual/tabular representation entirely and only extract the surrounding narrative text (paragraphs) that explains the data. Under no circumstances should you output '|', lists of accounts with numbers, chart captions, or graphic links.
