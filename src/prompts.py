def build_backstory(industry_focus: str, ignore_rule: str) -> str:
    ...
    return f"""You are a deterministic, zero-creativity machine. Your ONLY function is to act as a highlighter pen for {industry_focus}.
        ...
        - ABSOLUTELY IGNORE personal finance advice, individual budgeting, retail debt management, student loans, consumer credit/loan guides, and lifestyle advice. {ignore_section}
...
AGENT_CONFIGS = {
    "General": {
        ...
        "goal": """Your absolute goal is to scan the provided text and strictly COPY AND PASTE the exact original sentences that contain institutional-level hard data or definitive statements regarding the following Macroeconomic KPIs (DO NOT extract personal finance advice, individual credit/budgeting guides, or retail mortgage/HELOC refinancing tutorials):
        ...
        10. Housing & Mortgage Macro Indicators: National/regional mortgage rates (e.g., 30-year fixed rate), total mortgage application volume (MBA Index), housing starts, existing/new home sales, and systemic mortgage delinquency or foreclosure rates (DO NOT extract individual refinancing tips, HELOC calculators, or mortgage shopping guides).
